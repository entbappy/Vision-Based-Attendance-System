...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        clientID = tk.Label(self.window, text="Roll No.", width=10, height=2, fg="white", bg="#363e75", font=('times', 15))
        ...
        empID = tk.Label(self.window, text="Regis No.", width=10, fg="white", bg="#363e75", height=2, font=('times', 15))
        ...
        link2 = tk.Label(self.window, text="Welcome", fg="blue", )
        link2.place(x=690, y=580)
        # link2.pack()
        link2.bind("<Button-1>", lambda e: self.callback("https://github.com/entbappy"))
